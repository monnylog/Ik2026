...
const tourSteps: TourStep[] = [
  {
    ...
    subtitle: "May 22, 2026 · Las Vegas",
    body: "This is your home base. Take things at your own pace \u2014 we're glad you're here.",
  ...
  },
  {
    ...
    body: "Head to Settings to customize how you appear in chat and across the hub.",
    cta: "Go to Settings",
    navigateTo: "Settings",
  },
  {
    ...
    body: "Visit Menu & Courses when you're ready. Save drafts and come back anytime.",
  ...
  },
  {
    ...
    body: "Check Travel & Lodging for logistics. Mark your travel as confirmed from your dashboard.",
  ...
  },
  {
    ...
    body: "Real-time channels for the whole team. Connect with your research partner here too.",
    cta: "Open Comms",
    navigateTo: "Comms",
  },
  {
    ...
    subtitle: "Your dashboard tracks everything",
    body: "Take it one step at a time. We're here whenever you need support.",
    cta: "Go to Dashboard",
