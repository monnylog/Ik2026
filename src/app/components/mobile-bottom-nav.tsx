...
const moreNavItems: MoreNavItem[] = [
  ...
  { icon: ListChecks, label: "Pre-Event Checklist", page: "Pre-Event Checklist", color: "#C9A96E", teamAndUp: true },
  { icon: Tag, label: "Task Board", page: "Task Board", color: "#4A7FB5", teamAndUp: true },
  { icon: CalendarClock, label: "Event Schedule", page: "Event Schedule", color: "#6B7F8E" },
  { icon: ClipboardList, label: "Activity Log", page: "Activity Log", color: "#C9A96E", leadershipOnly: true },
  ...
  { icon: Wallet, label: "Reimbursements", page: "Reimbursements", color: "#7E9E78", leadershipOnly: true },
  { icon: Receipt, label: "Expenses", page: "Expenses", color: "#C9A96E", leadershipOnly: true },
