...
Assignments, Capacity, Gaps & RACI — Who owns what, who's stretched, and where the holes are.
...
## Event Questions (Internal)

- One seating? Or two seatings?
- **Vision:** Unite chefs from areas where Filipinos made their mark on US history, explain how each region/state is significant (and why they should be highlighted)
- The How?
    - Our research team (Andrew, Ava, JJ, and Armida) partner up with each chef on the roster and work with them on building a dish that speaks to their region or timeline in history
    ...
    ~~Tim and Genie - Chicago?~~ 
    
    ### Course 1. Las Vegas, NV | 1911 / Modern Era
...
- **Purpose:** To bring Filipino food forward by uniting our people; shedding light on the people in each region, the ingredients that stemmed from there; etc.
...
## FOH Staffing Needs (200+ guests)

**Year 2 had 3 servers + 3 runners + 2 bar + 1 host + 2 dish + 1 GM for ~55/seating.**

For 200+ guests, need **2–3x** that staffing level.

- [ ]  Tap existing Istorya FOH staff first (servers, runners, bussers, dishwashers, bartenders)

- [ ]  Explore culinary school students, community volunteers, etc (comp tickets in exchange)

## BOH Staffing Needs (200+ guests)

- [ ]  Determine if selected chefs require own staff (their Sous Chef, etc.)

## Questions for Chefs

Where will you be traveling from? City and nearest airport

- City of Departure:
- Nearest Major Airport:
- Preferred Method of Travel (if not flying; driving, train, etc.): 

Do you have any dietary restrictions or allergies we should be aware of?

What is your shirt size? 

Would you be interested in leading a short talk, demo, or storytelling about your culinary journey? 
...
Is there a dish you make that feels like it belongs to two different places at the exact same time?

What is a truth about your heritage that you can only express through a dish
...
- [ ]  Identify expo
- [ ]  Explore culinary school students / community volunteers (comp tickets in exchange)
- [ ]  Tap existing Istorya staff first

---

## Research Team Assignments (1 researcher per chef)

Year 2 model: Cat=Origins, Andrew=Binondo, Armida=Sulu

Year 3 needs 7 assignments — **Andrew (or JJ) to assign by Mar 14–18**
...
Walbert Castillo — Co-Owner, EP Restaurant Lead. Active.

Monica Blanco — Co-Owner, EP Agency Lead. Active.

Ayce Mangapit — Creative Director (Team Directory). Listed as Content/Video Production lead in RACI .

Jaryd Lucero — Lead Editor (Team Directory). Listed as Content/Video Production in RACI .

Christine Antonio — Project Manager (Team Directory). Ticketing/Booking Platform in RACI.
...
Ava Carino — Food Historian, Event Lead, Host (Team Directory). Events/Research/FOH.

Flerine Cruz Atienza — EP, Brand & Story (Team Directory). Leadership/Production/PR.

Zwei — Social Media Lead/Editor (Team Directory). Production/FOH.
...
Bingle (Pizarro) — In Istorya directory as Photography.

Dio + Justin — Kitchen/BOH leads in RACI. Not in Istorya Team Directory.

Jerjon — Finance in RACI. Not in Team Directory.
...
Sarah Obal added as HR/Operations (new for Y3).
